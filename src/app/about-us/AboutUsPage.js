  ...
  return (
    <div className='relative'>
      <div
        ...
        style={{ backgroundImage: "url('/assets/images/bg/banner-fout-bg.webp')" }}
      >
        <div className='absolute top-0 left-0'>
          <Image src='/assets/images/shape/banner-four-arrow.webp' alt="banner-four-arrow" fill sizes='100%' loading="lazy"/>
        </div>
        <div className='absolute top-[40%] left-[45%] h-90'>
          <Image src='/assets/images/shape/download__1_-removebg-preview.webp' className='h-full w-full' alt='removebg-preview' loading="lazy" fill/>
        </div>

        <AboutHero data={{
          img:"/assets/images/about/about-three-kit.webp",
          heading:"About Us",
          slug:"about-us",
