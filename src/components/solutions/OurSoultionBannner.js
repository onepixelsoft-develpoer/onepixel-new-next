...
export default function OurSoultionBannner({ data }) {
  return (
    <section className="relative w-full lg:h-[50vh] h-full bg-white my-10 flex  items-center wow  animate__animated  animate__fadeInUp">
      <div className="relative z-10 flex items-center  lg:items-center md:items-start lg:flex-row flex-col-reverse justify-between xl:px-40 px-5 w-full h-full bg-linear-to-r from-black to-red-900  text-white py-10 gap-5 overflow-hidden">
        <div className="absolute z-1  -bottom-50 left-0 lg:rotate-30 wow  animate__animated  animate__fadeInLeft" data-wow-delay="0.5s">
          <div className='realtive lg:h-100  w-160'>
            <Image loading="lazy" src='/assets/images/shape/imgi_138_learning-bg.svg' className='object-contain' fill sizes='100%' alt="design" />
          </div>
        </div>
